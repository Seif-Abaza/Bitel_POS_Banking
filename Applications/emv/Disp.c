...
#include "Disp.h"
char gbLangCode=0;
#define LANGUAGE_MAX    2       /* for MultiLanguage, Can't Modify */
...
//    "4.Basic TEST    ", //  4
    ...
    "IFM detected....", // 88
    "No IFM detected.", // 89
    "Please Wait ....", // 90 //Printer& LCD for ISO8583
    "TOT:            ", // 91
    "YYMM :          ", // 92
...
// For PinPAD
    ...
    {  -1,  -1,  81,  -1 }, //#define LsPIN_OK  {  -1,  81,  -1,  -1 },
...
int getCurrencyExp(int code)
{
    ...
    while(1) {
        cn = gc4217Name[i].CurrencyCode;
        if((cn == code)||(cn==0x0000)) {
            return(gc4217Name[i].CurrencyExp);
        }
        i++;
    }
    return(0);
